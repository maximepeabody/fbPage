...
(function($) {
	...
	/*********************************************************************************/
		...
		skel.init({
			...
			pollOnce: true,
			breakpoints: {
				'global':	{ range: '*', href: 'template1/css/style.css' },
				'desktop':	{ range: '737-', href: 'template1/css/style-desktop.css', containers: 1200, grid: { gutters: 25 }, viewport: { width: 1080, scalable: false } },
				'mobile':	{ range: '-736', href: 'template1/css/style-mobile.css', containers: '100%!', grid: { collapse: true, gutters: 15 }, viewport: { scalable: false } }
			}
		});
